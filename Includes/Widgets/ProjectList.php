...
class ProjectList extends Widget_Base {
	...
	public function get_name() {
		return 'gpt-project-list';
	}

	public function get_title() {
		return __( 'MPT Project List', 'gpt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'layout', [
			...
			'options' => [
				'1' => esc_html__( 'Style One', 'gpt-core' ),
				'2' => esc_html__( 'Style Two', 'gpt-core' ),
				'3' => esc_html__( 'Style Three', 'gpt-core' ),
			],
			'default' => '1',
		] );
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			<?php if ( $gpt_query->have_posts() ) : ?>
				<?php while ( $gpt_query->have_posts() ) : $gpt_query->the_post(); ?>
					...
					if ( $index % 2 == 0 ) {
						$odd_class = 'gpt-project--left';
					} else {
						$odd_class = 'gpt-project--right';
					}
					...
					?>
					<div class="gpt-project <?php echo $odd_class; ?>">
