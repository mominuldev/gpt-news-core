 ...
 * @since 1.0.0
 */
class FancyHeading extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf( __( '<div style="font-style:normal">If you want to use highlighted text use shortcode. Example:<br/><br/> <span style="font-weight:bold">[ld_highlight]</span> Your Text <span style="font-weight:bold">[/ld_highlight]</span></div>', 'gpt-core' ) ),
				'separator' => 'after',
		...
		$this->add_control(
			'tag',
			[
				'label' => esc_html__( 'Element Tag', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'add_gradient',
			[
				'label' => __( 'Gradient And Mask Image?', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'yes',
				'default' => ''
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'color2',
				'label' => __( 'Fancy Heading Background', 'gpt-core' ),
		...
		$this->add_control(
			'use_inheritance',
			[
				'label' => __( 'Inherit font styles?', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_split',
			[
				'label' => __( 'Enable text split?', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'lines',
				'options' => [
					'lines'  => __( 'Lines', 'gpt-core' ),
					'words' => __( 'Words', 'gpt-core' ),
					'chars, words' => __( 'Characters', 'gpt-core' ),
				],
				'condition' => [
					'enable_split' => 'true',
				],
		...
		$this->add_control(
			'use_mask',
			[
				'label' => __( 'Enabled mask?', 'gpt-core' ),
				'description' => __('Check to enable mask on title to use it in animation', 'gpt-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_txt_rotator',
			[
				'label' => __( 'Enable text rotator?', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'rotator_type',
			[
				'label' => __( 'Animation type', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Slide', 'gpt-core' ),
					'basic' => __( 'Basic', 'gpt-core' ),
					'list' => __( 'List', 'gpt-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			'rotator_delay', [
				'label' => __( 'Words stay time', 'gpt-core' ),
				'description' => __( 'Stay time for each word in seconds. Default is 2 seconds', 'gpt-core' ),
				'type' => Controls_Manager::TEXT,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color start', 'gpt-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color stop', 'gpt-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$this->add_control(
			'items',
			[
				'label' => __( 'Text rotator words', 'gpt-core' ),
				'type' => Controls_Manager::REPEATER,
		...
		$this->add_control(
			'whitespace',
			[
				'label' => __( 'Whitespace', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Normal', 'gpt-core' ),
					'ws-nowrap' => __( 'Nowrap', 'gpt-core' ),
				]
			]
		);
		...
		$this->add_control(
			'highlight_type',
			[
				'label' => __( 'Type', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'lqd-highlight-underline',
				'options' => [
					''  => __( 'None', 'gpt-core' ),
					'lqd-highlight-underline'  => __( 'Classic', 'gpt-core' ),
					'lqd-highlight-custom-underline' => __( 'Custom 1', 'gpt-core' ),
					'lqd-highlight-custom-underline lqd-highlight-custom-underline-alt' => __( 'Custom 2', 'gpt-core' ),
					'lqd-highlight-custom lqd-highlight-custom-3' => __( 'Custom 3', 'gpt-core' ),
					'lqd-highlight-custom lqd-highlight-custom-4' => __( 'Custom 4', 'gpt-core' ),
					'lqd-highlight-custom lqd-highlight-custom-5' => __( 'Custom 5', 'gpt-core' ),
				],
			]
		);
		...
		$this->add_control(
			'highlight_animation',
			[
				'label' => __( 'Animation', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'lqd-highlight-grow-left',
				'options' => [
					'lqd-highlight-grow-left'  => __( 'Grow From Left', 'gpt-core' ),
					'lqd-highlight-grow-bottom' => __( 'Grow From Bottom', 'gpt-core' ),
					'lqd-highlight-fadein' => __( 'Fade In', 'gpt-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			...
			[
				'label' => __( 'Fill Text On Hover?', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'highlight_color',
			[
				'label' => __( 'Highlight Color', 'gpt-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'highlight_type' => 'lqd-highlight-underline',
				),
		...
		$this->add_responsive_control(
			'highlight_offset',
			[
				'label' => __( 'Bottom Offset', 'gpt-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line bottom offset, for ex -10px', 'gpt-core' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Left Offset', 'gpt-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line left offset, for ex -10px', 'gpt-core' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
		...
		$this->add_responsive_control(
			'highlight_roudness',
			[
				'label' => __( 'Roundness', 'gpt-core' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Add line roudness in px, for ex 5px', 'gpt-core' ),
				'condition' => array(
					'highlight_type' => 'lqd-highlight-underline',
				),
				'selectors' => [
		...
		$this->add_control(
			'hover_text_outline',
			[
				'label' => __( 'Outline Text', 'gpt-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gpt-core' ),
				'label_off' => __( 'Off', 'gpt-core' ),
		...
		$this->add_control(
			'outline_appearance',
			[
				'label' => __( 'Appearance', 'gpt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'None', 'gpt-core' ),
					'ld-fh-outline-static' => __( 'Default', 'gpt-core' ),
					'ld-fh-outline' => __( 'On Hover', 'gpt-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => '2px',
				'placeholder' => __( 'Set hover text outline width in px. for ex. 5px', 'gpt-core' ),
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Vertical Text', 'gpt-core' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'ld_inner_margin',
			[
				'label' => __( 'Heading Margin', 'gpt-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'default' => [
					'bottom' => '0.5',
		...
		$this->add_responsive_control(
			'ld_inner_padding',
			[
				'label' => __( 'Heading Padding', 'gpt-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sticky Color', 'gpt-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Colors Over Light Rows', 'gpt-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Colors Over Dark Rows', 'gpt-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo MPT_Helper::sanitize_html_classes( $classes ); ?>">
	...
	protected function fancy_title() {
		...
		$title = $settings['advanced_text_enable'] === 'yes' ? $this->ld_el_get_advanced_text( $this ) : $settings['content'];
		...
		if( 'ld-fh-outline' === $settings['hover_text_outline'] ) {
			$outline_title = '<span class="ld-fh-txt-outline">' .  $this->do_the_content( $title, false ) . '</span>';
		}
		...
		if( $title ) {
			if ( !empty ( $link ) ) {
				...
				printf( '<%1$s %3$s %4$s><a%5$s %7$s'. $this->get_split_options() .'>%6$s %2$s</a></%1$s>', !empty( $tag ) ? $tag : 'h2', $this->do_the_content( $title, false ), $classnames, $this->get_data_opts(), esc_attr( $link ), $outline_title, $inline_edit_attr);
			}
			else {
				printf( '<%1$s %3$s %4$s %6$s'. $this->get_split_options() .'>%5$s %2$s</%1$s>', !empty( $tag ) ? $tag : 'h2', $this->do_the_content( $title, false ), $classnames, $this->get_data_opts(), $outline_title, $inline_edit_attr);
			}
	...
	protected function get_data_opts() {
		...
		return MPT_Helper::html_attributes( $opts );
