...
class Tabs extends Widget_Base {
	...
	public function get_title() {
		return __( 'GPT Tabs', 'gpt-news-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'tab_label' => __( 'Product', 'gpt-news-core' ),
					],
					[
						'tab_label' => __( 'Customer', 'gpt-news-core' ),
					],
					[
						'tab_label' => __( 'Pricing', 'gpt-news-core' ),
					],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'center',
				'selectors' => [
					'{{WRAPPER}} .gpt-dynamic-tabs-nav' => 'text-align: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tab_wrapper' ) ?>>
			<div class="gpt-tabs-nav-wrapper">
			...
			<div id="gpt-dynamic-tabs-content" class="ollix-dynamic-tabs-wrapper">
