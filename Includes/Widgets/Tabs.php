...
class Tabs extends Widget_Base {
	...
	public function get_title() {
		return __( 'PPS Tabs', 'pps-passport-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'tab_label' => __( 'Product', 'pps-passport-core' ),
					],
					[
						'tab_label' => __( 'Customer', 'pps-passport-core' ),
					],
					[
						'tab_label' => __( 'Pricing', 'pps-passport-core' ),
					],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'center',
				'selectors' => [
					'{{WRAPPER}} .pps-dynamic-tabs-nav' => 'text-align: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tab_wrapper' ) ?>>
			<div class="pps-tabs-nav-wrapper">
			...
			<div id="pps-dynamic-tabs-content" class="ollix-dynamic-tabs-wrapper">
